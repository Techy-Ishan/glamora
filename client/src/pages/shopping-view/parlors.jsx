...
function ShoppingParlors() {
  ...
  return (
    <>
        ...
        <div className="container px-4 py-8 mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-gray-600">
              {parlorList.length} parlors found
            </div>
          </div>
      ...
      {/* Parlor Registration Advertisement Banner */}
      <div
        className="text-white"
        style={{
          background: "linear-gradient(to right, #8a6f70, #7a5f60)",
          margin: 0,
          padding: "4rem 0",
          marginTop: "-1px",
          marginBottom: "-1px",
      ...
      >
        <div className="container px-4 mx-auto text-center">
          <h3 className="mb-4 text-3xl font-bold">
            Register Your Beauty Parlor with Glamora
          </h3>
          <p className="mb-6 text-xl text-gray-100">
            Join our platform and connect with thousands of beauty enthusiasts
          </p>
          <p className="text-lg text-gray-200">
            Contact us: +977-9861854034 | business@glamora.com
          </p>
        </div>
      </div>
    </>
